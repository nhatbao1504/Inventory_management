...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2024 at 06:02 PM
...
INSERT INTO `account` (`id_account`, `username`, `password`, `email`, `status`, `permission`, `created_at`, `updated_at`, `id_employee`) VALUES
...
--
-- Table structure for table `account_import`
--
...
INSERT INTO `certificate_type` (`id_certificate_type`, `certificate_type_name`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `contacts` (`id_contact`, `phone_number`, `cic_number`, `cic_issue_date`, `cic_expiry_date`, `cic_place_issue`, `current_residence`, `permanent_address`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `employees` (`id_employee`, `employee_code`, `photo`, `last_name`, `first_name`, `en_name`, `gender`, `marital_status`, `date_of_birth`, `national`, `military_service`, `cv`, `id_contact`, `created_at`, `updated_at`, `department_id`, `fired`) VALUES
...
INSERT INTO `history_type` (`id_history_type`, `history_type_name`) VALUES
(1, 'Recent Project');
...
INSERT INTO `job_detail` (`id_job_detail`, `id_job_title`, `id_job_category`, `id_job_type_contract`, `id_job_team`, `id_job_country`, `id_job_level`, `id_job_location`, `id_job_position`, `start_date`, `end_date`, `created_at`, `updated_at`, `id_employee`) VALUES
...
INSERT INTO `job_title` (`id_job_title`, `job_title`) VALUES
(1, 'CEO'),
(2, 'Legal Officer'),
...
INSERT INTO `materials` (`material_id`, `material_code`, `material_name`, `description`, `brand`, `origin`, `unit`, `quantity`, `unit_price`, `labor_price`, `total_price`, `vat`, `delivery_time`, `warranty_time`, `remarks`) VALUES
...
INSERT INTO `medical_checkup` (`id_medical_checkup`, `medical_checkup_file`, `medical_checkup_issue_date`, `id_employee`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `order_project` (`order_id`, `order_code`, `order_name`, `order_owner`, `status`, `create_date`, `total_price`, `VAT`) VALUES
(0, 'P01', 'P001 ', 'Bảo', '1', '2024-08-13', 100000000, 100000),
(0, 'P02', 'P0002', 'Duy', '1', '2024-08-31', 20000000, 200000),
(0, 'P01', 'P001 ', 'Bảo', '1', '2024-08-13', 100000000, 100000),
(0, 'P02', 'P0002', 'Duy', '1', '2024-08-31', 20000000, 200000);
...
--
-- Table structure for table `order_project_detail`
--

CREATE TABLE `order_project_detail` (
  `order_id` int(11) NOT NULL,
  `order_code` text NOT NULL,
  `marterial_id` int(11) NOT NULL,
...
INSERT INTO `passport` (`id_passport`, `passport_number`, `passport_issue_date`, `passport_expiry_date`, `passport_place_issue`, `passport_file`, `id_employee`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `phases` (`phase_id`, `phase_name`, `project_id`) VALUES
...
INSERT INTO `projects` (`project_id`, `project_name`, `project_description`, `project_address`, `project_main_contractor`, `project_contact_name`, `project_contact_website`, `project_contact_phone`, `project_date_start`, `project_date_end`, `phase_id`, `employees_id`, `project_price_contingency`, `project_contact_address`) VALUES
...
INSERT INTO `project_cost` (`project_cost_id`, `project_id`, `project_cost_description`, `project_cost_labor_qty`, `project_cost_labor_unit`, `project_cost_budget_qty`, `project_budget_unit`, `project_cost_labor_cost`, `project_cost_misc_cost`, `project_cost_perdiempay`, `project_cost_remaks`, `project_cost_group_id`, `project_cost_datagroup_id`, `project_cost_ot_budget`) VALUES
...
--
-- Table structure for table `project_cost_datagroup`
--
...
--
-- Dumping data for table `project_cost_datagroup`
--

INSERT INTO `project_cost_datagroup` (`project_cost_datagroup_id`, `project_cost_group_id`, `project_cost_groupdata_name`) VALUES
...
--
-- Table structure for table `project_cost_group`
--
...
--
-- Dumping data for table `project_cost_group`
--

INSERT INTO `project_cost_group` (`project_cost_group_id`, `project_cost_group_name`) VALUES
(1, 'COST OF LABOR'),
(2, 'COST OF TRAVEL'),
(3, 'COST OF RENTING'),
(4, 'COST OF OTHER'),
...
--
-- Table structure for table `project_daily_report_workday`
--
...
--
-- Table structure for table `project_daily_report_worker`
--
...
INSERT INTO `recent_project` (`id_recent_project`, `id_account`, `project_id`, `created_at`) VALUES
...
INSERT INTO `sub_tasks` (`sub_task_id`, `task_id`, `sub_task_name`, `progress`, `start_date`, `end_date`, `initial_quantity`, `engineers`, `report_information`, `area`, `actual_quantity`, `state`, `difficulties`, `request`) VALUES
...
INSERT INTO `tasks` (`task_id`, `phase_id`, `project_id`, `task_name`, `progress`, `start_date`, `end_date`, `initial_quantity`, `engineers`, `report_information`, `area`, `actual_quantity`, `state`, `difficulties`, `request`) VALUES
...
--
-- Table structure for table `team_position`
--
...
--
-- Indexes for table `account_import`
--
...
--
-- Indexes for table `project_cost_datagroup`
--
...
--
-- Indexes for table `project_cost_group`
--
...
--
-- Indexes for table `team_position`
--
...
--
-- AUTO_INCREMENT for table `account_import`
--
ALTER TABLE `account_import`
...
--
-- AUTO_INCREMENT for table `project_cost_datagroup`
--
ALTER TABLE `project_cost_datagroup`
...
--
-- AUTO_INCREMENT for table `team_position`
--
ALTER TABLE `team_position`
...
--
-- Constraints for table `project_cost_datagroup`
--
ALTER TABLE `project_cost_datagroup`
