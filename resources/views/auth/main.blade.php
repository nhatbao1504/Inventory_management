            ...
            <li class="nav-item">
                ...
                <ul id="inventory-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a class="nav-sub-link"
                           href="{{ action('App\Http\Controllers\MaterialsController@getView') }}">
                            <i class="bi bi-circle"></i><span>{{ __('messages.import') }}</span>
                        </a>
                    </li>
                    <li>
                        <a class="nav-sub-link"
                           href="{{ action('App\Http\Controllers\OrderController@getView') }}">
                            <i class="bi bi-circle"></i><span>{{ __('messages.order') }}</span>
                        </a>
                    </li>
                    <li>
                        <a class="nav-sub-link"
                           href="{{ action('App\Http\Controllers\MaterialsController@getView') }}">
                            <i class="bi bi-circle"></i><span>{{ __('messages.sales_project') }}</span>
                        </a>
                    </li>
                    <li>
                        <a class="nav-sub-link"
                           href="{{ action('App\Http\Controllers\MaterialsController@getView') }}">
                            <i class="bi bi-circle"></i><span>{{ __('messages.summary') }}</span>
                        </a>
                    </li>
                </ul>
            </li>
